...
class ExportView(Gtk.Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._view_stack: Adw.ViewStack | None = None
            def run_export():
                frame_restorer_options = FrameRestorerOptions(self._config.mosaic_restoration_model, self._config.mosaic_detection_model, video_utils.get_video_meta_data(source_file.get_path()), self._config.device, self._config.max_clip_duration, False, False, self._config.re_mosaic_block_size)
